package com.example.testbase.sw;
...
import com.example.testbase.sw0.NearTabFragment;
import com.example.testbase.sw0.NearTabFragment1;
import com.example.testbase.sw0.NearTabFragment2;
import com.example.testbase.sw0.NearTabFragment3;
 ...
 *
 */
public class MainTab extends BaseFragmnetActivity {
	...
	public Class[] ClassTab = { NearTabFragment.class, NearTabFragment1.class,
	...
	// 图片加载动画效果
	// public static ImageLoadingListener animateFirstListener = new
	...
	// 实例化
	public static MainTab instance;// 单利
	...
	// 单利模式来获取Activity的实例
	public static final MainTab Instance() {
		if (null == instance) {
	...
	protected void initData() {
		...
		// fragments.add(new NearTabFragment());
		// fragments.add(new NearTabFragment1());
	 ...
	 * displayedImages.add(imageUri); } else {

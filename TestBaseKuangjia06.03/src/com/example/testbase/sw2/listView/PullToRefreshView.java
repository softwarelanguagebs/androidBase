package com.example.testbase.sw2.listView;
...
/**
 * 可以把listview ,gridiview 直接放入其中， 然后上下都可以拉。。。。 触发对应的异步事件。。。
 * 
 * @author Thinkpad
 *
 */
public class PullToRefreshView extends LinearLayout {
	 ...
	 * header refresh time
	 */
	private TextView mHeaderUpdateTextView;// 顶部 最后更新的时间
	private TextView mHeaderUpdateTextView1;// 底部最后更新的时间
	...
	public boolean onTouchEvent(MotionEvent event) {
		...
		case MotionEvent.ACTION_DOWN:
			...
			break;
		case MotionEvent.ACTION_MOVE:
			int deltaY = (y - mLastMotionY) * 2; // 本来 (y -
													// mLastMotionY).为了方便手势上下拉,减小了手势下拉的距离。
	...
	public void onHeaderRefreshComplete() {
		...
		// 显示更新的时间
		mHeaderUpdateTextView.setText("上次更新："
	...
	public void onFooterRefreshComplete() {
		...
		// 显示更新的时间
		mHeaderUpdateTextView1.setText("上次更新："
				+ Calendar.getInstance().getTime().toLocaleString());

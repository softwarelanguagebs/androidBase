...
public class PullToRefreshListActivityBoth extends Activity implements OnClickListener
{
    ...
    private void initValue()
    {
    	...
    	mAdapter = new AdapterNearInfo(PullToRefreshListActivityBoth.this, items);

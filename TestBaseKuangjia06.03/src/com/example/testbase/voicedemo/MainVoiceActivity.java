...
public class MainVoiceActivity extends Activity implements
		AudioItemView.OnAudioItemClickListener {
			...
			handler.post(new Runnable() {
				...
				public void run() {
					...
					if (info != null && info.length() > 0) {
						Utils.show(info, MainVoiceActivity.this);
					} else {
						Utils.show("录音出错", MainVoiceActivity.this);
					}
				}
			});
		}
	...
	private class ListViewAdapter extends BaseAdapter {
		...
		public View getView(int position, View convertView, ViewGroup parent) {
			...
			if (convertView == null) {
				convertView = new AudioItemView(MainVoiceActivity.this);
			...
			itemView.setOnAudioItemClickListener(MainVoiceActivity.this);
			return itemView;
		}

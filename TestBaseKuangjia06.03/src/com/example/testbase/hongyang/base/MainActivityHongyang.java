package com.example.testbase.hongyang.base;

import com.example.testbase.hongyang.animator.AnimatorActivity2;
import com.example.testbase.hongyang.animator.CategoryListActivity;
...
public class MainActivityHongyang extends Activity  {
...
//	Button btn49;
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.activity_main_hongyang);
		

		initButton(btn1, R.id.btn1, com.example.testbase.hongyang.CustomView.MainActivity.class);
		...
		initButton(btn17, R.id.btn17, AnimatorActivity2.class);
		initButton(btn18, R.id.btn18, CategoryListActivity.class);
	...
	public void initButton(Button btn, int id, final Class c) {
		...
		btn.setOnClickListener(new View.OnClickListener() {
			public void onClick(View v) {
				...
				Intent intent = new Intent(MainActivityHongyang.this, c);

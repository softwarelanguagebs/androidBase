 ...
 *
 */
public class MainTab0 extends BaseFragmnetActivity  {
...
//R.layout.tab_main_first
	// tab 选中的activity
	private Class[] ClassTab = { NearTabFragment.class, NearTabFragment1.class,
...
//	public static ImageLoadingListener animateFirstListener = new AnimateFirstDisplayListener();
	...
	// 实例化
	public static MainTab0 instance;// 单利
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.newmaintabs0);
	...
	// 单利模式来获取Activity的实例
	public static final MainTab0 Instance() {
		if (null == instance) {
			instance = new MainTab0();
		}
		return instance;
	}

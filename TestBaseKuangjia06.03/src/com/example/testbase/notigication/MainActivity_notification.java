package com.example.testbase.notigication;
 ...
 * 通知栏应用
 */
public class MainActivity_notification extends BaseActivity implements OnClickListener{
...
//		notification.flags = Notification.FLAG_AUTO_CANCEL; //在通知栏上点击此通知后自动清除此通知
		...
		Intent resultIntent = new Intent(this, MainActivity_notification.class);

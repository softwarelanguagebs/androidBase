...
public class WeiXin_uiMainActivity extends FragmentActivity
{
	...
	protected void onCreate(Bundle savedInstanceState)
	{
		...
		setContentView(R.layout.activity_main_weixin_ui);
		...
		mViewPager.setOnPageChangeListener(new OnPageChangeListener()
		{
			...
			public void onPageSelected(int position)
			{
				...
				case 0:
					...
					mBadgeView = new BadgeView(WeiXin_uiMainActivity.this);
